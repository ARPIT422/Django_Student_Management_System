...
urlpatterns = [
   ...
   path('manage_session_save',HodViews.manage_session_save,name='manage_session_save'),
...
#staff views
   ...
   path('student_view_attendance_past',StudentViews.student_view_attendance_past,name='student_view_attendance_past'),
